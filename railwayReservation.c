...
void main()
{
	...
	printf("\t\tThe Following Trains "
		"Are Available.....\n");
	printf("\t\t1. Chattala Express.."
		".......10:00 "
		"a.m........Dhaka to Chittagong  Dhaka Station\n");
	printf("\t\t2. Turna Express..."
		".......05:00 "
		"p.m........Dhaka to Chittagong  Dhaka Station\n");
	printf("\t\t3. Parabat Express..."
		".......11:00 "
		"p.m........Dhaka and Sylhet  Dhaka KamalaPur"
		" Station\n");
	printf("\t\t4. Sundarban Express"
		".........05:00 "
		"p.m........Dhaka to khulna Dhaka KamalaPur Station\n");
	printf("\t\t5. Padma Express..."
		".........07:00 "
		"a.m.........Dhaka to Rajshahi  Dhaka"
		"Station\n");
	scanf("%d", &i);
	do {
		switch (i) {
		case 1: {
			strcpy(train,
				"Chattala Express");
			strcpy(station,
				"Dhaka to Chittagong  Dhaka Station");
			time1 = 10;
			time2 = 00;
			a1 = 2099;
			a2 = 1560;
		...
		case 3: {
			strcpy(train,
				"Parabat Express");
			strcpy(station,
				"Dhaka and Sylhet  Dhaka KamalaPur");
			time1 = 11;
			time2 = 00;
			a1 = 2199;
			a2 = 1780;
		...
		case 4: {
			strcpy(train, "Sundarban Express");
			strcpy(station, "Dhaka to khulna Dhaka KamalaPur Station");
			time1 = 05;
			time2 = 00;
			a1 = 1759;
			a2 = 1200;
		...
		case 5: {
			strcpy(train, "Padma Express");
			strcpy(station, "Dhaka to Rajshahi  Dhaka Station");
			time1 = 07;
			time2 = 00;
			a1 = 2205;
			a2 = 1905;
